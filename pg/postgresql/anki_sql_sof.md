...
{{c1::CREATE OR REPLACE}} FUNCTION foo()
  RETURNS {{c2::TABLE (a int, b int, c int)}} AS
$func$
{{c3::BEGIN}}
   RETURN {{c4::QUERY VALUES}}
     {{c5::(1,2,3)
        , (3,4,5)
           , (3,4,5)}};
END
$func$  {{c6::LANGUAGE}} plpgsql IMMUTABLE ROWS 3;
...
FROM   tbl t, unnest({{c1::string-to-array}}({{c2::t.elements}}, ',')) WITH ORDINALITY a({{c3::elem, nr}}); <br>
