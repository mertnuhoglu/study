// @description: Can we make `isolate` return correct type?
...
function comp_a(sources: Sources & SoHTTP): Sinks { // @essence
    const parentReducer$ = model_a()
    const cmp_b = isolate(comp_b) as Component<Sources & SoHTTP, Sinks> 
