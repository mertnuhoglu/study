...
Component:
    ...
    input: sources.DOM
    input: sources.onion.state$
    output: sink.onion: reducer$
    output: sink.DOM: vdom$
...
/Users/mertnuhoglu/codes/js/meeting-price-calculator
...
## Me: Onion Architecture Templates
