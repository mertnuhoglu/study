...
## p02: Type Error: Type '{}' provides no match for the signature '(s: any): any'. id=g10220

		p02: Type Error: Type '{}' provides no match for the signature '(s: any): any'.  <url:file:///~/projects/study/js/study_ts.Rmd#r=g10220>
...
### p02_03: Why does `isolate()` remove type information? id=g10222

		p02_03: Why does `isolate()` remove type information?  <url:file:///~/projects/study/js/study_ts.Rmd#r=g10222>

Edit `/Users/mertnuhoglu/projects/study/js/ex/study_ts/src/problems/p02/ex03.ts`

Continue: p18: Why Does `isolate()` Remove Type Information? Reimplementing `isolate()` <url:file:///~/projects/study/js/study_notes_cyclejs.Rmd#r=g10223>
...
type AB = A extends B ? true : false // false
type BA = B extends A ? true : false // true
// B extends A
// A doesn't extend B
``` 
...
From a set perspective. Take the sets:
...
From a set perspective. Take the instances of the sets:

- a_and_b is both A and B. It can substitute both at the same time.
- a_or_b is either A or B. 

From a members perspective. 

- a_and_b has properties of both A and B.
- a_or_b has properties of either A or B. 

Intersection is useful when used as: `a_and_b: A & B`

		function main(sources: Sources & SoHTTP): Sinks & SiHTTP & SiHot {

Union is usually used as: `<T extends AorB>`

		type State = AppState | PlanPanelState
		type Reducer<T extends State> = (prev?: T) => T  
...
## article: Advanced Types - Typescript Handbook id=g10224
...
## article: TypeScript Evolution - Marius Schulz  id=g10231

		article: TypeScript Evolution - Marius Schulz  <url:file:///~/projects/study/js/study_ts.Rmd#r=g10231>
...
## article: TypeScript Handbook: Generics  id=g10232

		article: TypeScript Handbook: Generics  <url:file:///~/projects/study/js/study_ts.Rmd#r=g10232>
...
## article: Real World Use Case For Typescript Record Types id=g10229

		article: Real World Use Case For Typescript Record Types <url:file:///~/projects/study/js/study_ts.Rmd#r=g10229>
...
## Article: Learn Typescript in 30 Minutes id=g10233

		Article: Learn Typescript in 30 Minutes <url:file:///~/projects/study/js/study_ts.Rmd#r=g10233>
...
## Article: TypeScript 2.8 Conditional Types id=g10234

		Article: TypeScript 2.8 Conditional Types <url:file:///~/projects/study/js/study_ts.Rmd#r=g10234>
