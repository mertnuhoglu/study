          ...
          form(".yeni_plan", {
            ...
            div(".yeni_plan__arac_parametreleri", [
              ...
              input("#kamyon.yeni_plan__input.form-control", {
                "attributes": {
                  "type": "text",
                  "className": "yeni_plan__input form-control"
                },
                "id": {
                  "name": "id",
                  "value": "kamyon"
