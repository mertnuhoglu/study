...
#
# pnxt: [[list_files_for_gotodef.nu]]
...
FILE_EXTENSIONS="-e clj -e cljc -e cljs -e txt -e md -e lua -e otl -e tsv -e html -e R -e sh -e css -e Rmd -e json -e yaml -e sql  -e edn -e csv -e vim -e log -e xml -e bb -e nu "
