...
drv <- JDBC("com.microsoft.sqlserver.jdbc.SQLServerDriver",
           "/Users/mertnuhoglu/codes/java/jdbc/mssql-jdbc-9.4.0.jre8.jar",
           identifier.quote="`")
conn <- dbConnect(drv, "jdbc:sqlserver://dcw-test.layermark.com;database=maxtest", Sys.getenv("LAYERMARK_DB_USER"), Sys.getenv("LAYERMARK_DB_PASSWORD"))
