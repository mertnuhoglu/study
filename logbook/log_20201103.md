...
```bash
Utl openLink ~/projects/study/otl/names.otl#r=g11659
```
...
```bash
Utl openLink <url:file:///~/projects/study/otl/names.otl#r=g11659>
```
...
# Data organization in spreadsheets - Karl Broman id=g11703
