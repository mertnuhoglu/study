...
``` otl
opt01: Terminal'in renkleri nasıl? onunkiler tamamen yanlış.
...
`remove node_modules files recursively <url:file:///~/projects/study/bash/examples_bash.Rmd#r=g11003>`
