...
# Datomic Müfredatı 20220927  id=g13408
...
Bir komplo teorisi paylaşayım: MVC, SOA, DRY, TDD. Bütün bu kısaltmalar projelerinizi zehirliyor. Bunlar günümüzün yılan yağlarıdır (snake oil). Çünkü bunlar hep fazla vaatte bulunup, bunları karşılayamazlar. Ve bunu yaparken yanıltıcı bir güvenlik hissi oluştururlar. 
...
TDD yaklaşımının amcı güven (confidence) sağlamaktır. Fakat bunu sağlayan başka şeyler de var: Types/schemas, assertions, generative property testing. Amacımız güvense neden bunları ihmal ediyoruz? TDD'nin çözdüğü birçok mesele bunlarla çözülebilir.
...
Bu duran bilgiyi modellemek için kullanılır. Fakat iletişimi modelleyemez. Çünkü iletişim, bilgiyi aktarmaya ait bir yöntemdir (protokol).
...
Ayrıca atributların değerleri, başka varlıklara referans olabilir.
...
Her nedense, kaynak kodu bizim için çok önemlidir. İş verisini ne yaparız? Çoğu zaman değişken bir veritabanının içine atarız. Bu organizasyonun özüdür. Buna özen ve saygı göstermeliyiz.
...
Ama belli sorgu türleri belli türdeki inndeksler için uygundur. Fakat bunu modelleyebiliriz.
...
İş sahası büyük oranda çizge tipindedir. Bu veri yapısında sorgular, hem ileri doğru dolaşmayı, hem de geriye doğru dolaşmayı gerektirir. Geriye doğru dolaşma yeni bir indeks gerektirir: `[a v e t]`
...
Bence hepimiz sıralara odaklanmalıyız. Bunu yeterince kullanmıyoruz. Günün sonunda, enformasyon sistemleri, içinden verilerin geçtiği sıralardır.
