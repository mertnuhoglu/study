(ns mertnuhoglu.rtc.datalog_for_trees_e01
...
; Takes examples from: [JUXT Blog - Datalog for trees in Clojure](https://www.juxt.pro/blog/datascript-dom)
...
(defn- to-entity [node]
  (if-not (string? node)
    (merge
      ...
      ;;id will be given a special name
