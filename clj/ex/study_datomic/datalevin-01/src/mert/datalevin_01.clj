(ns mert.datalevin-01)

;; Copied from: [juji-io/datalevin: A simple, fast and versatile Datalog database](https://github.com/juji-io/datalevin)

;; Step 0: run datalevin server
;; dtlv serv -r /tmp/datalevin-01
