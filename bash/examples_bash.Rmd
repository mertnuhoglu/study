...
opt02: relative paths id=g10956
...
# install apps  id=g12781

## install all dependencies together in a script

Example install scripts:

```
~/projects/itr/vrp/vrprapi/inst/install_software.sh
~/projects/itr/fmcgvrp/pvrp/scripts/install_software_common.sh
~/projects/bizqualify/BizQualify/datarun/datarun01.sh
```
...
### ffmpeg: video encoding id=g11000
...
Ref: `rsync --delete <url:file:///~/projects/study/code/study_rsync.md#r=g10932>`
...
### remove node_modules files recursively id=g11003
...
ref: `sort examples <url:file:///~/projects/study/logbook/log_20200520.md#r=g11005>`
...
### count files in directories id=g11012
...
### navigate recursively subdirectories and execute command id=g11663
