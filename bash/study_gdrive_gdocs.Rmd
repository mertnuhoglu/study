...
library(googledrive)
drive_find(q = "name contains 'Antifragile'")
drive_find(n_max = 50)
drive_find(pattern = "Antifragile")
drive_find(type = "")
``` 
...
af0 = drive_ls("~/Play Books Notes/", q = "name contains 'Antifragile'")
af0
  ##>   name                                                         id                                           drive_resource
  ##> * <chr>                                                        <chr>                                        <list>
