...
### opt02: complete process eng_word,tur_word,image id=g_10821

Kelimeleri önce bir dosyada tablo içinde listeleyelim. Sonra resimleri bu tabloda ekleyelim.

Örnek: `~/gdrive/mynotes/stuff/ozgur_emin/english/anki/exam_20191024/words_20191110.tsv`

3 kolon: ingilizce kelime, türkçesi, resim dosyasının ismi

		president	başkan	word_president.jpg

``` bash
~/projects/anki_english/scripts/anki_resize_images
~/projects/anki_english/scripts/anki_rename_jpg word_
file="words_20191202.tsv"
~/projects/anki_english/scripts/anki_jpg_2_images_2 $file
~/projects/anki_english/scripts/anki_merge_images $file
tags="exam201912"
~/projects/anki_english/scripts/anki_sheets_2_anki_txt_2 "${tags}"
